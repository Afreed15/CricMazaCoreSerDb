...
namespace CricMazaServerDb.Models
{
    public partial class CricMaza21Context : DbContext
    {
        ...
        {
            modelBuilder.Entity<MatchList>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("MatchList");

                entity.Property(e => e.MatchList1)
                    .IsRequired()
                    .HasColumnName("MatchList")
                    .HasMaxLength(100);
            ...
            modelBuilder.Entity<Matches>(entity =>
            {
                entity.HasKey(e => e.Mid)
                    .HasName("PK__Matches__C79638C259AAC2B3");
                ...
                entity.HasOne(d => d.Team1Navigation)
                    ...
                    .HasConstraintName("FK__Matches__team1__7F2BE32F");

                entity.HasOne(d => d.Team2Navigation)
                    .WithMany(p => p.MatchesTeam2Navigation)
                    .HasForeignKey(d => d.Team2)
                    .HasConstraintName("FK__Matches__team2__00200768");
            });
